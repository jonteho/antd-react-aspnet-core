    ...
    public render() {
        ...
        >
          ...
          <Menu theme="light" mode="inline" defaultSelectedKeys={['1']}>
            ...
            <Menu.Item key="5">
                <span><Icon type="book" /><span className="menuItemText">Cards</span></span>
              <NavLink to={ '/cards' } activeClassName='active'></NavLink>
            </Menu.Item>
            <SubMenu key="6" title={<span><Icon type="upload" /><span className="menuItemText">Submenu</span></span>}>
                 <Menu.Item key="6.1">
